...
$query = $conn->query("SELECT id projectID,name FROM project_list");
    ...
    $qry = $conn->query("SELECT DISTINCT p.id projectID, p.name  FROM project_list p
...
<div class="container-fluid">
    <form id="employee-form" action="" method="post">
        ...
        <div class="row">
            <div class="form-group col-md-4">
                <select name="proj_id[]" id="proj_id" class="form-control form-control-sm form-control-border" multiple>
                ...
                <small class="mx-2">Project Name</small>
        </div>
        <div class="row">
            <div class="form-group col-md-10">
